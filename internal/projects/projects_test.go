...
func TestRegisterAndList(t *testing.T) {
	...
	err := Register("/home/user/project1", "/home/user/project1/.floyd")
	if err != nil {
	...
	if projects[0].DataDir != "/home/user/project1/.floyd" {
		t.Errorf("Expected data_dir /home/user/project1/.floyd, got %s", projects[0].DataDir)
	}

	// Register another project
	err = Register("/home/user/project2", "/home/user/project2/.floyd")
	if err != nil {
		t.Fatalf("Register failed: %v", err)
	}
...
func TestRegisterUpdatesExisting(t *testing.T) {
	...
	err = Register("/home/user/project1", "/home/user/project1/.floyd-new")
	if err != nil {
		t.Fatalf("Register failed: %v", err)
	}
	...
	if projects[0].DataDir != "/home/user/project1/.floyd-new" {
...
func TestRegisterWithParentDataDir(t *testing.T) {
	...
	// e.g., working in /home/user/monorepo/packages/app but .floyd is at /home/user/monorepo/.floyd
	err := Register("/home/user/monorepo/packages/app", "/home/user/monorepo/.floyd")
	if err != nil {
		t.Fatalf("Register failed: %v", err)
	}
	...
	if projects[0].DataDir != "/home/user/monorepo/.floyd" {
		t.Errorf("Expected data_dir /home/user/monorepo/.floyd, got %s", projects[0].DataDir)
	}
}
...
func TestRegisterWithExternalDataDir(t *testing.T) {
	...
	// e.g., project at /home/user/project but data stored at /var/data/floyd/myproject
	err := Register("/home/user/project", "/var/data/floyd/myproject")
	if err != nil {
		t.Fatalf("Register failed: %v", err)
	}
	...
	if projects[0].DataDir != "/var/data/floyd/myproject" {
		t.Errorf("Expected data_dir /var/data/floyd/myproject, got %s", projects[0].DataDir)
	}
}
