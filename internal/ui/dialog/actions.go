...
type (
	...
	// ActionCycleTheme cycles to the next UI theme preset.
	ActionCycleTheme struct{}
	// ActionCycleThemeReverse cycles to the previous UI theme preset.
	ActionCycleThemeReverse struct{}
	// ActionToggleTerminal toggles the embedded terminal panel.
	ActionToggleTerminal struct {
		Index int // 0 for toggle current, 1-9 for specific terminal
	}
