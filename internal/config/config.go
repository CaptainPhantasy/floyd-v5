...
type Attribution struct {
	...
	GeneratedWith bool         `json:"generated_with,omitempty" jsonschema:"description=Add Generated with Floyd line to commit messages and issues and PRs,default=true"`
}
...
type Options struct {
	...
	DataDirectory             string       `json:"data_directory,omitempty" jsonschema:"description=Directory for storing application data (relative to working directory),default=.floyd,example=.floyd"` // Relative to the cwd
...
// Config holds the configuration for floyd.
type Config struct {
