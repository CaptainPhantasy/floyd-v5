...
func TestProviders_Integration_WithMockClients(t *testing.T) {
	...
	catwalkPath := tmpDir + "/floyd/providers.json"
	hyperPath := tmpDir + "/floyd/hyper.json"
...
func TestProviders_Integration_WithCachedData(t *testing.T) {
	...
	require.NoError(t, os.MkdirAll(tmpDir+"/floyd", 0o755))
...
func TestCachePathFor(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expected:    "/custom/data/floyd/providers.json",
		},
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.expected != "" {
				...
				require.Contains(t, result, "floyd")
