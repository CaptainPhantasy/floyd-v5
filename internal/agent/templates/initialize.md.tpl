...
**Goal**: Document what an agent needs to know to work in this codebase - commands, patterns, conventions, gotchas. Append project-specific rules below the standard FLOYD.md protocol.
...
5. If {{.Config.Options.InitializeAs}} exists, read and preserve the protocol header, update only project-specific sections
...
**Format**: The file MUST start with the standard FLOYD.md protocol header (PRIME DIRECTIVE through MEMORY & CONTINUITY sections). Project-specific rules are appended after the line "**Add project-specific rules below this line.**"

Here is the exact protocol header to use:
