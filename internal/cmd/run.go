...
curl https://charm.land | floyd run "Summarize this website"

# Read from a file
floyd run "What is this code doing?" <<< prrr.go

# Run in quiet mode (hide the spinner)
floyd run --quiet "Generate a README for this project"

# Run in verbose mode
floyd run --verbose "Generate a README for this project"
  `,
