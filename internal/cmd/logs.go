...
var logsCmd = &cobra.Command{
	Use:   "logs",
	Short: "View floyd logs",
	Long:  `View the logs generated by Floyd. This command allows you to see the log output for debugging and monitoring.`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		logsFile := filepath.Join(cfg.Options.DataDirectory, "logs", "floyd.log")
		_, err = os.Stat(logsFile)
		if os.IsNotExist(err) {
			log.Warn("Looks like you are not in a floyd project. No logs found.")
			return nil
		}
