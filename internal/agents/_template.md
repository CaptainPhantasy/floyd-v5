...
trigger: "[optional-trigger-keyword]"
version: "1.0.0"
tags: [tag1, tag2, tag3]
---
...
[Describe what this agent does first to understand context]

PHASE 2: [CORE EXECUTION]
[Describe the main work this agent performs]

PHASE 3: [VALIDATION & HANDOFF]
[Describe how this agent validates its work and what it outputs]
...
For [PRIMARY REQUEST TYPE], use:
1) CONTEXT INFERRED (what you understood from the request)
2) [SECTION 2 NAME]
3) [SECTION 3 NAME]
4) [SECTION 4 NAME]
5) RISKS & NEXT STEPS
6) HANDOFF NOTES (if another agent should continue)

For [SECONDARY REQUEST TYPE], use:
