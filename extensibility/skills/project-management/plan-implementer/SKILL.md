...
Customize these paths and commands for your project:
...
When things do not match the plan exactly, think about why and communicate clearly. The plan is your guide, but your judgement matters too.

### Handling Mismatches

If you encounter a mismatch between the plan and reality:

1. STOP and think deeply about why the plan cannot be followed
...
- If the plan explicitly describes multiple phases, follow them in order
...
- Check what has already been completed (existing checkmarks)
...
Do not re-implement what is already marked complete unless there is a specific reason.
...
4. Do not proceed with uncertain implementation
...
For most implementation work, operate directly in the main context.

## Important Guidelines

**1. Follow intent, not just instructions**
- Understand why the plan calls for something
- Adapt when reality does not match expectations
...
1. Read docs/plans/2025-10-27-add-auth.md fully
2. Identify phases and success criteria
3. Implement Phase 1 according to the plan
4. Run make test and make lint
5. Present manual verification steps and pause
6. After confirmation, proceed to Phase 2, repeating the cycle
```
