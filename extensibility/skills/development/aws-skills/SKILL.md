---
name: aws-skills
description: AWS development with CDK best practices, cost optimization MCP servers, and serverless/event-driven architecture patterns. Use for AWS CDK infrastructure as code, cost estimation and optimization, serverless application development, event-driven architectures, and Bedrock AgentCore AI agent deployment.
---

# AWS Skills for Floyd

Floyd plugins for AWS development with specialized knowledge and MCP server integrations, including CDK, serverless architecture, cost optimization, and Bedrock AgentCore for AI agent deployment.
...
MCP server names use short identifiers to comply with Bedrock's 64-character tool name limit. The naming pattern is:
...
- https://docs.floyd.com/en/docs/floyd-code/skills
